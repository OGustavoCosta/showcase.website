    ...
    return(
        <div className="grid grid-rows-default w-full min-h-screen text-light bg-background-light">
            <header className="header grid justify-items-center max-h-[420px]">
                <div className="header__banner w-full h-35 md:h-56 bg-background-dark overflow-hidden bg-cover bg-center bg-[url(/images/banners/linktree/v5.JPG)] md:bg-[url(/images/banners/linktree/v6.JPG)] ">
                </div>
